...
productOptionRoute.get('/size/view/:id', [auth, checkPermission('product_view')], fetchRecordOfSize);
...
productOptionRoute.get('/colour/view/:id', [auth, checkPermission('product_view')], fetchRecordOfColour);
